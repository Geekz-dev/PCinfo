...
function browser ($ua) { 
    ...
    $browser = array (
        ...
        '/(Sleipnir)\/([0-9\.]+)/' => 'Sleipnir',
        '/(KIKI)[\/\s]([0-9\.]+)/' => 'KIKI',
        '/(Iron)[\/\s]([0-9\.]+)/' => 'Iron',
        '/(Grani)[\/\s]([0-9\.]+)/' => 'Grani',
        '/(SuperBird)[\/\s]([0-9\.]+)/' => 'SuperBird',
        '/(CoolNovo)[\/\s]([0-9\.]+)/' => 'CoolNovo',
        '/(Chrome)\/([0-9\.]+)/' => 'Google Chrome',
        '/(Opera)[\/\s]([0-9\.]+)/' => 'Opera',
        '/(BOIE)([0-9\.]+)/' => 'Biohazard Operation Internet Explorer',
        '/(Lunascape)\s([0-9\.]+)/' => 'Lunascape',
...
function get_os_name($ua){
    ...
    $os_list = array(
        ...
        '/PlayStation Vita ([0-9\.]+)/' => 'PlayStation Vita',
